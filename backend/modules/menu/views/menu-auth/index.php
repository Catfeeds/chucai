...
/* @var $searchModel backend\modules\menu\models\MenuAuthSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Menu Auths');
...
<div class= "panel panel-default">
    ...
    <div class="panel-body">
        <?= Html::a('<i class="glyphicon glyphicon-plus"></i>'.Yii::t('app', 'Create Menu Auth'), ['create'], [
            'class' => 'data-create btn btn-sm btn-success modal-slef',
            'data-toggle' => 'modal',
            'data-target' => '#create-modal',
            'data-url' => '/menu/menu-auth/create',
            'data-title' => ''
        ]) ?>
            ...
            [
               ...
               // 'label'=>'管理区域',
                ...
                'value' => function ($model) {
                    return Menu::strByRules($model->rules);
                },
            ],
