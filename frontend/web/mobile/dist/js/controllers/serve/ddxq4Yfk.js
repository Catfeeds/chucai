'use strict';
app.controller('serveDetail4YfkCtrl', ['$scope','$rootScope','$http','$stateParams','$localStorage','$sessionStorage','$state','toaster','$timeout','$location',function($scope,$rootScope,$http,$stateParams,$localStorage,$sessionStorage,$state,toaster,$timeout,$location) {
    //弹窗
    $scope.mPop={
        content:{
            type: 'success',
    ...
    $scope.goToBack = function () {
        $sessionStorage.orderScrollTop = $stateParams.scrollTop;
        history.go(-1)
    }
}])
;
